...
- [ ] T002 Initialize project dependencies with pnpm (`pnpm install`) and lockfile policy
- [ ] T003 [P] Configure linting and formatting tools
- [ ] T004 [P] Verify Nuxt 4 + Vue 3 `script setup` baseline for touched modules
...
- [ ] T005 Setup shared UI foundation (Tailwind CSS + shadcn-vue tokens/components)
- [ ] T006 [P] Establish GSAP + single modern Lenis runtime (remove duplicate legacy providers)
- [ ] T007 [P] Define SSR data-fetching pattern for indexable pages and Sanity access layer
- [ ] T008 Create SEO baseline (`useSeoMeta` pattern, sitemap, favicon)
...
- [ ] T025 [P] [US3] Contract test for [endpoint] in tests/contract/test\_[name].py
- [ ] T026 [P] [US3] Integration test for [user journey] in tests/integration/test\_[name].py
...
- [ ] TXXX Remove unused components/routes/plugins introduced by legacy state
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX Validate SSR + `useSeoMeta` coverage on all indexable pages touched
